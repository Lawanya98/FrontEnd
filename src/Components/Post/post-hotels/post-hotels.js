        ...
        setTimeout(function () { //Start the timer
            axios
                .post('https://alphax-api.azurewebsites.net/api/hotelsservices/', {
                    ...
                    hotelImgURL: this.state.hotelImgURL,
                    roomImgURL01: this.state.roomImgURL01,
                    roomImgURL02: this.state.roomImgURL02,
                    roomImgURL03: this.state.roomImgURL03,
                    userID: '8c38ca3f-1ae6-4a7c-78ec-08d89bf76381',
                    ...
                    <form className="fback" onSubmit={this.handleSubmit}>
                        ...
                        <div className="row formmarge">
                            ...
                            <div className="col-sm-7">
                                ...
                                <input type="text" className="form-control" id="numofrooms" name="numofrooms"
                                    value={this.state.numofrooms} placeholder="of the above type" required/>
                            </div>
                            <div className="col-sm-4"></div>
                        </div>
                        ...
                        <div className="row formmarge">
                            ...
                            <div className="col-sm-7">
                                ...
                                <input type="text" className="form-control" name="bedtype" id="bedtype"
                                    value={this.state.bedtype} required/>
                            </div>
                            <div className="col-sm-4"></div>
                        </div>
                        ...
                        <div className="row formmarge">
                            ...
                            <div className="col-sm-6">
                                ...
                                <label htmlFor="image">Upload image of the Room</label>
