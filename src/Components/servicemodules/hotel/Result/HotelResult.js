                            ...
                            <Card.Body>
                                ...
                                <div className="container">
                                    ...
                                    <Table striped bordered hover>
                                        <thead>
                                            <tr>
                                                <th className="hotelresult-tableName">Room Name</th>
                                                <th className="hotelresult-tableGuests">Number of Guests</th>
                                                <th className="hotelresult-tableSpecs">Amenties</th>
                                                <th className="hotelresult-tablePrice">Price Per Day</th>
                                                <th className="hotelresult-a">Select num of rooms</th>
                                                <th className="hotelresult-b"></th>
                                            </tr>
                                        </thead>
                                    </Table>
                                </div>
