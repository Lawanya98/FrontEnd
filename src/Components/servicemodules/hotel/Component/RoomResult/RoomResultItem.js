        ...
        <div>
            <div>
                ...
                <Table striped bordered hover>
                    ...
                    <tbody>
                        <tr>
                            <td className="roomresult_tableName">{props.roomType}</td>
                            <td className="roomresult_tableGuests">{props.capacity}</td>
                            <td className="roomresult_tableSpecs">{props.features}</td>
                            <td className="roomresult_tablePrice">{props.pricePerDay}</td>
                            ...
                            <td>
                                <Link to={{ pathname: '/hotelCart' , data:data}}>
                                    <button type="button" className="btn btn roomresult_btn-secondary">Reserve Rooms</button>
                                </Link>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div className="roomresult_container" style={{ alignSelf: 'center' }}>
                <div className="row">
                    ...
                    <div className="roomresult_col-3"></div>
                </div>
            </div>
            <br />

            <div className="roomresult_container"></div>
