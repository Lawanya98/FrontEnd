    ...
    return (
        <div>
            ...
            <section className="tm-banner">
                <div className="hotelform-tm-container-outer hotelform-tm-banner-bg-hotel">
                    <div className="container">

                        <div className="row hotelform-tm-banner-row" id="tm-section-search">
                            <form className="hotelform-tm-search-form tm-section-pad-2" >

                                <div className="form-row tm-search-form-row">

                                    <div className="form-group hotelform-tm-form-group hotelform-tm-form-group-pad hotelform-tm-form-group-2">

                                            <label htmlFor="inputRoom" className="hotelform-tm-form-label-search" >District</label>
                                            <input
                                                name="destination"
                                                type="text"
                                                className="hotelform-form-control"
                                                id="inputCheckOut"
                                    ...
                                    <div className="form-group hotelform-tm-form-group hotelform-tm-form-group-pad hotelform-tm-form-group-2">
                                        <label htmlFor="inputCheckIn" className="hotelform-tm-form-label-search" >Check In </label>
                                        <input
                                            name="check-in"
                                            type="date"
                                            className="hotelform-form-control"
                                    ...
                                    <div className="form-group hotelform-tm-form-group hotelform-tm-form-group-pad hotelform-tm-form-group-2">
                                        <label className="hotelform-tm-form-label-search" htmlFor="inputCheckOut">Check Out </label>
                                        <input
                                            name="check-out"
                                            type="date"
                                            className="hotelform-form-control"
                                        ...
                                        <div className="form-group hotelform-tm-form-group hotelform-tm-form-group-pad hotelform-tm-form-group-3">
                                            <label htmlFor="inputRoom" className="hotelform-tm-form-label-search">Guests</label>
                                            <input
                                                name="check-out"
                                                type="number"
                                                className="hotelform-form-control"
                                    ...
                                    <div className="form-group hotelform-tm-form-group hotelform-tm-form-group-pad-btn tm-form-group-5">

                                        <Link
                                            type="submit"
                                            to={{ pathname:"/rooms" }}
                                            className="btn hotelform-btn-primary hotelform-tm-btn hotelform-tm-btn-search text-uppercase "
                                            id="btnSubmit"
                            ...
                            <div className="container hotelform-b1">
                                <Link type="submit"
                        ...
                        <div className="row hotelform-tm-banner-row hotelform-tm-banner-row-header">
                            <div className="col-xs-12">
                                <div className="hotelform-tm-banner-header">
                        ...
                        <div className="hotelform-tm-banner-overlay"></div>
